...
if (!isset($_SESSION['idUsuarioLogado']) && !isset($_COOKIE['idUsuarioLogado'])){
     header('Location: http://'.$_SERVER['HTTP_HOST'].'/sapataria/login.php');
}
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Sapataria Moon</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            ...
                                            <div>Cadastrar Modelo</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="addModelo.php">
                                    <div class="panel-footer">
                                        <span class="pull-left">NOVOS MODELOS</span>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-red">
                                ...
                                <a href="addUsuario.php">
                                    <div class="panel-footer">
                                        <span class="pull-left">NOVO USUÁRIO</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
